...
- 독서
   - [ ] 한번이라도 끝까지 버텨본 적 있는가 - 웨이슈잉
- CSS
   - [x] tailWindCSS 정리 및 연습
- Algorithm
   - [x] 하루에 1~2개씩 꾸준히(인프런)
- Green-Muhly
   - [x] Todo 반응형 UI 적용해보기(tailwindCSS)
- [ ] [TIL](https://github.com/souvenir718/TIL) 하루 계획 꾸준히
...
### :clock5: 2021.06.27 ~ 2021.07.03
> 휴일 : ❌

- 미라클 모닝
   - [x] AM 5시
- 독서
   - [x] 새 책 구매(한번이라도 끝까지 버텨본 적 있는가 - 웨이슈잉)
- JS
   - [x] pwa 책 보면서 공부(2~3장)
- [ ] [TIL](https://github.com/souvenir718/TIL) 하루 계획 꾸준히
...
### :clock5: 2021.04.11 ~ 2021.04.17
> 휴일 : ❌

- 미라클 모닝
   - [x] AM 5시 30분 .
   - [x] 독서(습관 디자인 45 - 이노우에 히로유키) 
- JS
   - [x] 알고리즘 관련 메소드 정리(Array)
- Algorithm
   - [x] 쉬운거부터 하루 하나씩 실천!
...
### :clock5: 2021.03.21 ~ 2021.03.27
> 휴일 : ❌

- 미라클 모닝
   - [x] 이번주에 AM 4시 30분 정착하기.
   - [x] 독서 (인간관계론 - 데일 카네기)
- React
   - [x] 만들었던 souTodo를 React로 바꿔보기!
